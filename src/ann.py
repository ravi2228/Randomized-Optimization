...
def train(oa, network, oaName, training_ints, testing_ints, measure, TRAINING_ITERATIONS, OUTFILE):
    ...
    for iteration in xrange(TRAINING_ITERATIONS):
        ...
        if iteration % 10 == 0:
    	    MSE_trg, acc_trg, F1_trg, pred_time = errorOnDataSet(network,training_ints,measure)
            MSE_tst, acc_tst, F1_tst, test_time = errorOnDataSet(network,testing_ints,measure)
            txt = '{},{},{},{},{},{},{},{},{}\n'.format(iteration,MSE_trg,MSE_tst,acc_trg,acc_tst,F1_trg,F1_tst,times[-1],pred_time);print txt
